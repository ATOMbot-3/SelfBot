...
cl = TOBY.LINE()
cl.login(token="En0iAWsmQsDuMzwGt6za.iMJNhj6r8eOFNUjDU2q92G.G1skadXfzZF1cTL4obJtWGb5qWSW4rXFkexgDD3J/OY=")
cl.loginResult()
...
creator=["u2268e71c9e91f04a1f9ee25dbb643dda"]
wait = {
    'contact':False,
    'autoJoin':True,
			...
			for zx in range(0,20):
				...
				if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
					try:    
						...
						kk.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by :SADISTIC\n\nAdd https://line.me/R/ti/p/%40ayu1654p")
						print "DiLike"
					except:
							pass
				else:
